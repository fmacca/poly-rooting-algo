...
folder_name='New_Results/Degree02_NoiseFullMatrix_ProjectionAndOthers_MULTIPLETIMES'; %Name for the results folder: it should be named after the kind of test performed
...
NRUNS=20; % Number of times we generate a different polynomial
