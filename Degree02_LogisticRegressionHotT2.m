...
plot(x,pihat(:,2),'r.');
xline(sep_line,'b--');
legend("P-value of Hotelling T^2 test","Level \alpha=0.05 for T^2 test","Fitted model","Separating line from model","Location","Northwest");
...
legend("Fitted vs actual","Chosen model threshold","Level \alpha=0.05 for T^2 test","Location","Southeast")
